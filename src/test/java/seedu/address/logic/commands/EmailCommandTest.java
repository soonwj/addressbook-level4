...
public class EmailCommandTest {
    ...
    public void execute_multipleKeywords_multiplePersonsFound() {
        ...
        EmailCommand command = prepareCommand("Kurz Elle Kunz");
     ...
     */
    private void assertCommandSuccess(EmailCommand command, String expectedMessage, List<ReadOnlyPerson> expectedList) {
