...
This will invoke the `removeTag` function that resides in the `LogicManager`, which will remove the specific tag from all the contacts and updates the storage.
