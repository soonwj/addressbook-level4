...
As seen in the above diagram, an event based approach is used to display the location of the contact.
...
This will eventually render the browser panel with Google Maps and a marker pointing at the address of the requested contact.
