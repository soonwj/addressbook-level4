...
[width="59%",cols="22%,<23%,<25%,<30%,<20%",options="header",]
|=======================================================================
...
|`* * *` |new user |sort contacts |look through the list easier |
...
|`* * *` |user |update each contact's information | |

|`* * *` |user |search for contacts by common tags | |

|`* * *` |user |favourite a contact | |

|`* * *` |user |search for a particular contact | |

|`* * *` |user |view history of recent commands | |
...
|`* *` |user |import all existing contacts |use the app with less set-up time |
...
2.  AddressBook prompts google login for authentication
3.  User enters authentication information
4.  AddressBook shows a list of incoming contacts
5.  AddressBook prompts for confirmation
6.  User accepts
7.  AddressBook updates contact list
+
Use case ends.
