...
This will eventually render the browser panel with Google Maps and a marker pointing at the address of the requested target person. 

This rendering of Google Maps uses URL in the browser panel.
